...
private:
	...
	/////////////////////////////////////////////////////////////////////
	uint32_t noOfLogicalRegisters;
	uint32_t freeListSize;
	uint32_t activeListSize;
	uint32_t physicalRegFileSize;
	uint32_t noOfUnresolvedBranches;
	...
	CircularFIFO<uint64_t> *freeList;
	/////////////////////////////////////////////////////////////////////
	...
	struct {
	bool destFlag;
	uint64_t destLogicalReg;
	uint64_t destPhysicalReg;
	bool complete;
	bool exception;
	bool loadViolation;
	bool branchMispredict;
	bool valueMispredict;
	bool loadFlag;
	bool storeFlag;
	bool branchFlag;
	bool amoFlag;
	...
	CircularFIFO<activeListEntry> *activeList;
	/////////////////////////////////////////////////////////////////////
	...
	bool checkpointedFreeListHeadPhase;
	uint64_t checkpointedGBM;
	} branchCheckpointStruct;

	branchCheckpointStruct *branchCheckpoints;
	/////////////////////////////////////////////////////////////////////

	/////////////////////////////////////////////////////////////////////
	// Private functions.
	// e.g., a generic function to copy state from one map to another.
	uint32_t getFreeCheckpoints();
	uint32_t getFreeGBMBit();
	/////////////////////////////////////////////////////////////////////
