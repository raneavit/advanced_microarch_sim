...
bool VP_ENABLE_FLAG = false;
bool VP_PREDICTION_MODE = false;
uint64_t VP_TYPE = 0;
uint64_t SVP_VPQ_SIZE = 0;
uint64_t SVP_CONFIDENCE_MODE = 0;
...
bool SVP_PRED_INT_ALU = false;
bool SVP_PRED_FP_ALU = false;
bool SVP_PRED_LOAD = false;
uint64_t SVP_VPQ_FULL_POLICY = 0;
uint16_t ESVP_MAX_AGE = 0;
uint32_t ESVP_BHR_BITS = 0;
