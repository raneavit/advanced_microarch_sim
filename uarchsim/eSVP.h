...
class eSVP  : public value_predictor {
    private:
...
public:
	...
	eSVP(uint64_t vpq_size_in, uint64_t prediction_mode_in, uint64_t confidence_mode_in, uint64_t indexBits_in, 
        ...
        bool pred_fpu_alu_in, bool pred_load_in, uint64_t vpq_full_policy_in, uint16_t max_age, payload *PAY_in, pipeline_t *proc_in, renamer* REN_in);
