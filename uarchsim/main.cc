...
static void set_svp_config(const char* config) {
   uint64_t in_1, in_2, in_3, in_4, in_5, in_6, in_7, in_8, in_9, in_10, in_11, in_12, in_13;
   if (sscanf(config, "%lu,%lu,%lu,%lu,%lu,%lu,%lu,%lu,%lu,%lu,%lu,%lu,%lu", &in_1, &in_2, &in_3, &in_4, &in_5, &in_6, &in_7, &in_8, &in_9, &in_10, &in_11, &in_12, &in_13) != 13) {
      fprintf(stderr, "Incorrect usage of --vp-svp\n");
      exit(-1);
   }
   else {
      SVP_VPQ_SIZE = in_1;
      SVP_CONFIDENCE_MODE = in_2;
      SVP_INDEX_BITS = in_3;
      SVP_TAG_BITS = in_4;
      SVP_CONFMAX = in_5;
      SVP_CONFINC = in_6;
      SVP_CONFDEC = in_7;
      SVP_REPLACE_STRIDE = in_8;
      SVP_REPLACE = in_9;
      SVP_PRED_INT_ALU = (in_10 ? true : false);
      SVP_PRED_FP_ALU = (in_11 ? true : false);
      SVP_PRED_LOAD = (in_12 ? true : false);
      SVP_VPQ_FULL_POLICY = in_13;
   }
}

static void set_esvp_config(const char* config) {
   uint64_t in_1, in_2, in_3, in_4, in_5, in_6, in_7, in_8, in_9, in_10, in_11, in_12, in_13, in_14;
   if (sscanf(config, "%lu,%lu,%lu,%lu,%lu,%lu,%lu,%lu,%lu,%lu,%lu,%lu,%lu,%lu", &in_1, &in_2, &in_3, &in_4, &in_5, &in_6, &in_7, &in_8, &in_9, &in_10, &in_11, &in_12, &in_13, &in_14) != 14) {
      fprintf(stderr, "Incorrect usage of --vp-esvp\n");
      exit(-1);
   }
   else {
      SVP_VPQ_SIZE = in_1;
...
static void set_esvp_bhr_config(const char* config) {
   uint64_t in_1, in_2, in_3, in_4, in_5, in_6, in_7, in_8, in_9, in_10, in_11, in_12, in_13, in_14, in_15;
   if (sscanf(config, "%lu,%lu,%lu,%lu,%lu,%lu,%lu,%lu,%lu,%lu,%lu,%lu,%lu,%lu,%lu", &in_1, &in_2, &in_3, &in_4, &in_5, &in_6, &in_7, &in_8, &in_9, &in_10, &in_11, &in_12, &in_13, &in_14, &in_15) != 15) {
      fprintf(stderr, "Incorrect usage of --vp-esvp\n");
      exit(-1);
   }
   else {
...
int main(int argc, char** argv)
{
  ...
  parser.option(0,"vp-enable", 1, [&](const char* s){VP_ENABLE_FLAG = atoi(s);});
  parser.option(0,"vp-perf", 1, [&](const char* s){VP_PREDICTION_MODE = atoi(s);});
  parser.option(0, "vp-svp", 1, [&](const char* s){VP_TYPE = 0; set_svp_config(s);});
  parser.option(0, "vp-esvp", 1, [&](const char* s){VP_TYPE = 1; set_esvp_config(s);});
  parser.option(0, "vp-esvp-bhr", 1, [&](const char* s){VP_TYPE = 2; set_esvp_bhr_config(s);});
